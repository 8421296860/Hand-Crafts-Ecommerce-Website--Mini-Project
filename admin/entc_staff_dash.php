...
<html>
    <head>
        <title> ENTC Staff Dashboard </title>
    ...
    <body>
        ...
        <div class="jumbotron">
        	<h2 style="text-align: center;margin-top: 3%;">-: ENTC Staff Dashboard :-</h2><br>
            <div class="container-fluid">
          
                <div class="row">
                   <?php 
						if(isset($_GET['edit'])) { 
							$select_sql = "SELECT * FROM entc_staff_dash  WHERE id=$_GET[edit]";
							...
							echo "
								...
								<?php
									...
									<div class=form-group>
										...
										<a href='entc_staff_dash.php'><button class='btn btn-primary'>Cancel</button></a>
									</div>
								</form>
                    ...
                    <div class="col-md-9" id="left" >
                        ...
                        <table class="table table-responsive table-condensed">
                            ...
                            <tbody>
                            	<?php 
									$sql = "SELECT * FROM entc_staff_dash";
									...
									while($row = mysqli_fetch_assoc($result)){
										echo "
											<tr>
												...
												<td id='mystyle'>
													<a href='entc_staff_dash.php?edit=$row[id]'>
														<button class='btn btn-primary'>Edit</button>
													</a>
												</td>
												<td id='mystyle'>
													<a href='entc_staff_dash.php?id=$row[id]'>
...
<?php 
	if(isset($_POST['submit'])){
		...
		$insert_query = "INSERT INTO entc_staff_dash (fname,department,designation,qualification,grade,experience,gender,email,contact_number) VALUES ('$fname','$department', '$designation', '$qualification','$grade', '$experience', '$gender', '$email', '$contact_number')";
		
		if(mysqli_query($conn, $insert_query)) { ?>
			<script>window.location = 'entc_staff_dash.php'</script>
			
			<?php	
		}	
	}
    $insert_sql = "INSERT INTO entc_staff_dash (fname,department,designation,qualification,grade,experience,gender,email,contact_number) VALUES()";

	if( isset($_GET['id'])) {
		$del_sql = "DELETE FROM entc_staff_dash WHERE id = $_GET[id]";
	...
	if( isset($_GET['updateid'])) {
  	...
  	//for grade
		...
		$update_sql = "UPDATE entc_staff_dash SET fname ='$fname',department ='$department', designation='$designation',qualification='$qualification',grade='$grade', experience='$experience', gender='$gender', email='$email', contact_number ='$contact_number' WHERE id='$_GET[updateid]'";
