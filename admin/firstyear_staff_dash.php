...
<html>
    <head>
        <title> First year Staff Dashboard </title>
        ...
        <div class="jumbotron">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   <?php 
						if(isset($_GET['edit'])) { 
							$select_sql = "SELECT * FROM firstyear_staff_dash WHERE id=$_GET[edit]";
                    ...
                    <div class="col-md-9" id="left" >
                        ...
                        <table class="table table-responsive table-condensed">
                            ...
                            <tbody>
                            	<?php 
									$sql = "SELECT * FROM firstyear_staff_dash";
									...
									while($row = mysqli_fetch_assoc($result)){
										echo "
											<tr>
												...
												<td id='mystyle'>
													<a href='firstyear_staff_dash.php?edit=$row[id]'>
														<button class='btn btn-primary'>Edit</button>
													</a>
												</td>
												<td id='mystyle'>
													<a href='firstyear_staff_dash.php?id=$row[id]'>
...
<?php 
	if(isset($_POST['submit'])){
		...
		$insert_query = "INSERT INTO firstyear_staff_dash (fname,department,designation,qualification,grade,experience,gender,email,contact_number) VALUES ('$fname','$department', '$designation', '$qualification','$grade', '$experience', '$gender', '$email', '$contact_number')";
		
		if(mysqli_query($conn, $insert_query)) { ?>
			<script>window.location = 'firstyear_staff_dash.php'</script>
			
			<?php	
		}	
	}
    $insert_sql = "INSERT INTO firstyear_staff_dash (fname,department,designation,qualification,grade,experience,gender,email,contact_number) VALUES()";

	if( isset($_GET['id'])) {
		$del_sql = "DELETE FROM firstyear_staff_dash WHERE id = $_GET[id]";
	...
	if( isset($_GET['updateid'])) {
  	...
  	//for grade
		...
		$update_sql = "UPDATE firstyear_staff_dash SET fname ='$fname',department ='$department', designation='$designation',qualification='$qualification',grade='$grade', experience='$experience', gender='$gender', email='$email', contact_number ='$contact_number' WHERE id='$_GET[updateid]'";
