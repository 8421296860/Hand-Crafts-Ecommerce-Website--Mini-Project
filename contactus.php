...
<textarea class="form-control" placeholder="Write your Feedback/Suggestion here... " name="message" required=""></textarea>
                        ...
                        <h5>'S' Creations, Vishrantwadi</h5><br>
            <div class="contact-info"> 
            <h5><i class="fa fa-map-marker"></i>  Vishrantwadi<br><br>Pune-411015 (Maharashtra)<br><br>
            <i class="fa fa-phone"></i> 9511721580 <br><br> 
             <i class="fa fa-envelope-o"></i>  pranoj12@gmail.com   </h5> 
...
if(mysqli_query($con, $insert_query)) { ?>
			<script>window.location ='feedbackreceived.php'</script>
