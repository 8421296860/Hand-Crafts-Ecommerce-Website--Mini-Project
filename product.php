				...
				<div class="row">
					...
					<?php 
                                ...
                                <div id="product-main-img">
                                    <div class="product-preview">
                                        <img src="product_images/'.$row['product_image_name'].'" alt="">
                                    </div>

                                    <div class="product-preview">
                                        <img src="product_images/'.$row['sub_img_one'].'" alt="">
                                    </div>

                                    <div class="product-preview">
                                        <img src="product_images/'.$row['sub_img_two'].'" alt="">
                                    </div>

                                    <div class="product-preview">
                                        <img src="product_images/'.$row['sub_img_three'].'" alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">&#8377;'.$final_price.'
								<del class="product-old-price">&#8377;'.$row['product_price'].'</del></h3>
							...
							<ul class="product-links">
								<li>Category:</li>
								<li><a href="#"><p>'.$row['product_category'].'</p></a></li>
